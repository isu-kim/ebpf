...
import (
	...
	"github.com/isu-kim/ebpf/ringbuf"
...
//go:generate go run github.com/isu-kim/ebpf/cmd/bpf2go -tags "linux" -cc $BPF_CLANG -cflags $BPF_CFLAGS -type rtt_event bpf tcprtt_sockops.c -- -I../headers
