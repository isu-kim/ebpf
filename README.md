...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/isu-kim/ebpf)](https://pkg.go.dev/github.com/isu-kim/ebpf)
...
The community actively monitors our [GitHub Discussions](https://github.com/isu-kim/ebpf/discussions) page.
...
* [asm](https://pkg.go.dev/github.com/isu-kim/ebpf/asm) contains a basic
...
* [cmd/bpf2go](https://pkg.go.dev/github.com/isu-kim/ebpf/cmd/bpf2go) allows
...
* [link](https://pkg.go.dev/github.com/isu-kim/ebpf/link) allows attaching eBPF
  to various hooks
* [perf](https://pkg.go.dev/github.com/isu-kim/ebpf/perf) allows reading from a
  `PERF_EVENT_ARRAY`
* [ringbuf](https://pkg.go.dev/github.com/isu-kim/ebpf/ringbuf) allows reading from a
  `BPF_MAP_TYPE_RINGBUF` map
* [features](https://pkg.go.dev/github.com/isu-kim/ebpf/features) implements the equivalent
  of `bpftool feature probe` for discovering BPF-related kernel features using native Go.
* [rlimit](https://pkg.go.dev/github.com/isu-kim/ebpf/rlimit) provides a convenient API to lift
  the `RLIMIT_MEMLOCK` constraint on kernels before 5.11.
* [btf](https://pkg.go.dev/github.com/isu-kim/ebpf/btf) allows reading the BPF Type Format.
